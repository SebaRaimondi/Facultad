...
- no puede haber más de 5 usuarios con prioridad baja al mismo tiempo usando la BD.
  ...
  No es la forma correcta de declarar semaforos, se declaran con "sem nombreDeSemaforo = valorInicial" Se tiene que hacer P(sem) luego del P(alta/baja), ya que sino podrian pasar el P(sem) 6 prio baja,
